...
void _categorySerialize(
  ...
  writer.writeString(offsets[0], object.nameCategory);
}
...
Category _categoryDeserialize(
  ...
  object.id = id;
  object.nameCategory = reader.readString(offsets[0]);
  return object;
}
...
extension CategoryQueryFilter
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> nameCategoryEqualTo(
    String value, {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> nameCategoryLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> nameCategoryBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> nameCategoryEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> nameCategoryContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> nameCategoryMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQuerySortBy on QueryBuilder<Category, Category, QSortBy> {
  QueryBuilder<Category, Category, QAfterSortBy> sortByNameCategory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'nameCategory', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByNameCategoryDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQuerySortThenBy
  ...
  QueryBuilder<Category, Category, QAfterSortBy> thenByNameCategory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'nameCategory', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByNameCategoryDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'nameCategory', Sort.desc);
    });
  }
...
extension CategoryQueryWhereDistinct
  ...
  QueryBuilder<Category, Category, QDistinct> distinctByNameCategory(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQueryProperty
  ...
  QueryBuilder<Category, String, QQueryOperations> nameCategoryProperty() {
    return QueryBuilder.apply(this, (query) {
