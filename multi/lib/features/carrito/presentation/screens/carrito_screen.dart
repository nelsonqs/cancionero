...
class CarritoScreen extends StatelessWidget {
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      listItems.isNotEmpty
                                          ?  Text(
                                                'Bs. ${p.totalWithoutDiscount.toStringAsPrecision(2)}',
                                                style: const TextStyle(
                                                    fontSize: 14),
                                              )
                                          : const Text('')
                                      ...
                                      ElevatedButton(
                                          ...
                                          onPressed: listItems
                                                  ...
                                                  p.totalWithoutDiscount >
                                                      0
                                              ? () {
                                                  createSale(isSale: true, listItems: listItems,context: context);
                                                  ...
                                                  final snackBar = SnackBar(
                                                    ...
                                                    content: AwesomeSnackbarContent(
                                                      ...
                                                      message: 'La venta se registró satisfactoriamente!',
                                        ...
                                        ElevatedButton(
                                          ...
                                          onPressed: listItems
                                                  ...
                                                  p.totalWithoutDiscount >
                                                      0
                                              ? () {
                                                  createQuote(isSale: false,context:context);
                                                  p.updateDefaultvalue();
                                                  final snackBar = SnackBar(
                                                    elevation: 0,
                                                    behavior: SnackBarBehavior.floating,
                                                    ...
                                                    content: AwesomeSnackbarContent(
                                                      title: 'Carrito de Compras!',
                                                      message: 'La cotizacion se registró satisfactoriamente!',
  ...
  void createSale({required bool isSale, required List<Item> listItems, required BuildContext context}) async {
    final p = context.watch<ListItemFormCubit>();  
  ...
  void createQuote({required bool isSale, required BuildContext context}) async {
    final listItems = context.watch<ListItemFormCubit>().state.items;  
    final p = context.watch<ListItemFormCubit>();  
    List<ProductOrder> products = [];
    Person person = Person()
    ...
    for (var element in listItems) {
      ...
      product.quantity = element.quantity;
      product.weight = element.weightUnit;
      product.subTotalWeight =
          (element.weightUnit * element.quantitySale);
      product.inWishList = element.inWishList;
      product.quantitySale = element.quantitySale;
      product.subTotal =
          (element.quantitySale * element.price);
      products.add(product);
    }
  ...
  Future<int> saveOrder(Order newTeacher) async {
    return IsarManager().isar.writeTxnSync<int>(() => IsarManager().isar.orders.putSync(newTeacher));
  }

  Future<void> saveMovement(
      int orderId, List<ProductOrder> products) async {
    await IsarManager().isar.writeTxn(() async {
      for (var element in products) {
        ...
        movement.subTotal =
            (element.price * element.quantitySale);
